...
public class QuestionController {
	...
	@Autowired
	public QuestionController(QuestionDao questionDao, QnaService qnaService) {
		super();
	...
	public String show(@PathVariable long questionId, Model model)
		...
		model.addAttribute("answers",
				qnaService.findAllByQuestionId(questionId));
		return "/qna/show";
	}
	...
	public String edit(@LoginUser User loginUser, @PathVariable long questionId,
			Question editQuestion) throws Exception {
