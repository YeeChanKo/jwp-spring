...
import next.intercepter.BasicAuthIntercepter;
import next.intercepter.ProfilingIntercepter;
...
public class WebMvcConfig extends WebMvcConfigurerAdapter {
	...
	@Bean
	public ProfilingIntercepter profilingIntercepter() {
		return new ProfilingIntercepter();
	}
	...
	public void addInterceptors(InterceptorRegistry registry) {
		registry.addInterceptor(profilingIntercepter()).addPathPatterns("/**")
